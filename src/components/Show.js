      ...
      render={form => (
        ...
        <form onSubmit={form.handleSubmit}>
          <div /* className={this.classes.root} */>
            ...
            <React.Fragment>
              <Grid container /* spacing={3} */>
                <Grid item xs={6} className={this.classes.fieldArrayHeader}>
                  <Typography variant="h5">
                    Malt
                    <SvgIcon>
                ...
                <Grid item xs={6}>
                  <Grid container>
                    <Grid item xs={12}>
                      {console.log(form.values.malts)}
                      {form.values.malts !== undefined && form.values.malts.map((malt, index) => {
                        return console.log(malt)
                      })}
                      <FieldArray
                        name="malts"
                            ...
                            {form.values.malts !== undefined &&
                              form.values.malts.map((malt, index) => (
                                <Grid container key={index}>
                                  <Grid item xs={1} className={this.classes.fieldArrayIcon} style={{marginLeft: "1%"}}>
                                    <Fab
                                      size="small"
                                  ...
                                  <Grid item xs={1} className={this.classes.fieldArrayIcon} style={{marginLeft: "-2%"}}>
                                    <Fab
                                      size="small"
